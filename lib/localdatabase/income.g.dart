...
void _incomeAttach(IsarCollection<dynamic> col, Id id, Income object) {
  object.id = id;
  object.category
      .attach(col, col.isar.collection<IncomeCategory>(), r'category', id);
}
...
extension IncomeQueryFilter on QueryBuilder<Income, Income, QFilterCondition> {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> incomeDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'incomeDate',
        value: value,
      ));
    });
  }

  QueryBuilder<Income, Income, QAfterFilterCondition> incomeDateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> incomeDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> incomeDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> noteIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> noteIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension IncomeQuerySortThenBy on QueryBuilder<Income, Income, QSortThenBy> {
  ...
  QueryBuilder<Income, Income, QAfterSortBy> thenByIncomeDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'incomeDate', Sort.asc);
    });
  }
