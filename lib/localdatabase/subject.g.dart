...
const SubjectSchema = CollectionSchema(
  ...
  links: {
    r'school': LinkSchema(
      id: 5202692912841693143,
      name: r'school',
      target: r'School',
      single: true,
    ),
    r'grade': LinkSchema(
      id: -5882227176801662384,
      name: r'grade',
      target: r'Grade',
      single: true,
    ),
    r'schoolClass': LinkSchema(
      id: -8146851941205535478,
      name: r'schoolClass',
...
void _subjectSerialize(
  ...
  writer.writeDouble(offsets[2], object.maxMark);
...
Subject _subjectDeserialize(
  ...
  object.id = id;
  object.maxMark = reader.readDouble(offsets[2]);
...
List<IsarLinkBase<dynamic>> _subjectGetLinks(Subject object) {
  return [object.school, object.grade, object.schoolClass];
}
...
extension SubjectQueryFilter
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> maxMarkEqualTo(
    double value, {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> maxMarkGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> maxMarkLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> maxMarkBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension SubjectQueryLinks
    on QueryBuilder<Subject, Subject, QFilterCondition> {
  QueryBuilder<Subject, Subject, QAfterFilterCondition> school(
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> schoolIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'school', 0, true, 0, true);
    });
  }

  QueryBuilder<Subject, Subject, QAfterFilterCondition> grade(
      FilterQuery<Grade> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> schoolClass(
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> schoolClassIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension SubjectQuerySortBy on QueryBuilder<Subject, Subject, QSortBy> {
  ...
  QueryBuilder<Subject, Subject, QAfterSortBy> sortByMaxMark() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'maxMark', Sort.asc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> sortByMaxMarkDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'maxMark', Sort.desc);
    });
  }
...
extension SubjectQuerySortThenBy
  ...
  QueryBuilder<Subject, Subject, QAfterSortBy> thenByMaxMark() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'maxMark', Sort.asc);
    });
  }

  QueryBuilder<Subject, Subject, QAfterSortBy> thenByMaxMarkDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'maxMark', Sort.desc);
    });
  }
...
extension SubjectQueryWhereDistinct
  ...
  QueryBuilder<Subject, Subject, QDistinct> distinctByMaxMark() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'maxMark');
    });
  }
...
extension SubjectQueryProperty
  ...
  QueryBuilder<Subject, double, QQueryOperations> maxMarkProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'maxMark');
    });
  }
